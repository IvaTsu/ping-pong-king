          ...
          {playersList
            ...
            .map((player) => (
              <li key={player.id} className="m-2">
                <a
                  className="btn btn-outline font-ubuntuRegular hover:bg-lightGrey hover:border-navy dark:hover:bg-cloud w-full border-2 border-darkGrey text-black hover:text-black dark:text-white dark:hover:text-white"
                  onClick={() => {
